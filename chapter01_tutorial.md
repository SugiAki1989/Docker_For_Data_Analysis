...
Dockerイメージとはコンテナの実行に必要はファイルをまとめたシステムみたいなものです。Ubuntuのこのイメージであれば、`a4a2a29f9ba4`、`127c9761dcba`、`d13bf203e905`、`4039240d2e0b`の4つのイメージレイヤーで構成されています。何らかの変更が加わると新たなイメージレイヤーが作られます。
